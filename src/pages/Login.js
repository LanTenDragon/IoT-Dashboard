            ...
            m('div', { class: 'w3-container' },
              m('div', { class: 'w3-section' },
                [
                  ...
                  m('br'),
                  m('button', { class: 'w3-button w3-block w3-green w3-section w3-padding', disabled: !Auth.canSubmit(), onclick: Auth.login }, 'Login'),
                  m('div', { class: 'w3-text-red' }, Auth.error)
                ]
              )
            ),
            m('div', { class: 'w3-container w3-border-top w3-padding-16 w3-light-grey' },
              [
                m('button', { class: 'w3-button w3-red', onclick: function () { location.href = '#!/Register' }, type: 'button' },
                  'Register'
                )
              ]
            )
